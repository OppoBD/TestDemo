...
import com.baidu.wearable.test.wristbandtester.PhoneAnswerTestActivity;
 ...
 *
 */
public class PhoneAnswerTest extends TestCase {

	private BlueTooth mBlueTooth=BlueTooth.getInstance();
	private final String TAG = PhoneAnswerTest.class.getSimpleName();
		
	public PhoneAnswerTest(Context context) {
		super(context,context.getResources().getStringArray(R.array.test_menu)[21], 
				PhoneAnswerTestActivity.class);		
	}
	...
	public void onTestStart(AsyncTask task) {
		...
		mBlueTooth.phoneAnswer(new BlueToothCommonListener() {
					@Override
					public void onSuccess() {
						Log.d(TAG,"Phone answer send success");
						Message msg = mStatusHandler.obtainMessage(TestStatusHandler.TEST_STATUS_CHANGED);
						msg.arg1 = PhoneAnswerTestActivity.PHONEANSWER_SET_SUCCESS;
						mStatusHandler.sendMessage(msg);
					}

					@Override
					public void onFailure() {
						Log.e(TAG,"Phone answert send failure");
