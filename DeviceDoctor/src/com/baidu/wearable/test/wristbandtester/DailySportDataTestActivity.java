 ...
 *
 */
public class DailySportDataTestActivity extends TestActivity {

	public static final int DAILYSPORTDATA_SET_SUCCESS = 0;
	public static final int EVENT_CMD_SEND_FAIL = 1;
	private TextView mDailySportDataState;
	...
	protected void onCreate(Bundle savedInstanceState) {
		setContentView(R.layout.activity_dailysportdata);
		super.onCreate(savedInstanceState);
		mDailySportDataState = (TextView)findViewById(R.id.dailysportdata_state);
		mFailButton.setEnabled(true);
		mDailySportDataState.setText(R.string.bt_dailysportdata);
	}
	...
	protected TestStatusHandler initListener() {
		return new TestStatusHandler(){
			...
			public void handleMessage(Message msg) {
				...
				{
					switch(msg.arg1){
					case DAILYSPORTDATA_SET_SUCCESS:
				...
				case TEST_CONNECTION_FAIL:
					mDailySportDataState.setText(R.string.bt_connection_fail);
					mFailButton.setEnabled(true);
					mRestartButton.setVisibility(View.INVISIBLE);
					break;
				case TEST_TIMEOUT:
