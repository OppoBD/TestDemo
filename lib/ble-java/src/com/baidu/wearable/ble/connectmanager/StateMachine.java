...
class Hsm1 extends StateMachine {
    ...
    public static Hsm1 makeHsm1() {
        LogUtil.d(TAG, "makeHsm1 E");
        Hsm1 sm = new Hsm1("hsm1");
        sm.start();
        LogUtil.d(TAG, "makeHsm1 X");
        return sm;
    }

    Hsm1(String name) {
        super(name);
        LogUtil.d(TAG, "ctor E");
        ...
        setInitialState(mS1);
        LogUtil.d(TAG, "ctor X");
    }

    class P1 extends State {
        &#64;Override public void enter() {
            LogUtil.d(TAG, "mP1.enter");
        }
        &#64;Override public boolean processMessage(Message message) {
            boolean retVal;
            LogUtil.d(TAG, "mP1.processMessage what=" + message.what);
            switch(message.what) {
            case CMD_2:
        ...
        &#64;Override public void exit() {
            LogUtil.d(TAG, "mP1.exit");
        }
    }

    class S1 extends State {
        &#64;Override public void enter() {
            LogUtil.d(TAG, "mS1.enter");
        }
        &#64;Override public boolean processMessage(Message message) {
            LogUtil.d(TAG, "S1.processMessage what=" + message.what);
        ...
        &#64;Override public void exit() {
            LogUtil.d(TAG, "mS1.exit");
        }
    }

    class S2 extends State {
        &#64;Override public void enter() {
            LogUtil.d(TAG, "mS2.enter");
        }
        &#64;Override public boolean processMessage(Message message) {
            boolean retVal;
            LogUtil.d(TAG, "mS2.processMessage what=" + message.what);
            switch(message.what) {
            case(CMD_2):
        ...
        &#64;Override public void exit() {
            LogUtil.d(TAG, "mS2.exit");
        }
    }

    class P2 extends State {
        &#64;Override public void enter() {
            LogUtil.d(TAG, "mP2.enter");
            sendMessage(obtainMessage(CMD_5));
        }
        &#64;Override public boolean processMessage(Message message) {
            LogUtil.d(TAG, "P2.processMessage what=" + message.what);
            switch(message.what) {
            case(CMD_3):
                break;
            case(CMD_4):
        ...
        &#64;Override public void exit() {
            LogUtil.d(TAG, "mP2.exit");
        }
    }

    &#64;Override
    void halting() {
        LogUtil.d(TAG, "halting");
        synchronized (this) {
            this.notifyAll();
        }
    }
...
synchronize(hsm) {
     ...
     try {
          ...
          LogUtil.e(TAG, "exception while waiting " + e.getMessage());
     }
}
</code>
 * <p>The output is:</p>
...
public class StateMachine {
    ...
    private  class SmHandler extends Handler {
        ...
        public final void handleMessage(Message msg) {
            if (mDbg) LogUtil.d(TAG, "handleMessage: E msg.what=" + msg.what);
            ...
            if (!mIsConstructionCompleted) {
                LogUtil.e(TAG, "The start method not called, ignore msg: " + msg);
                return;
            }
            ...
            if (mDbg) LogUtil.d(TAG, "handleMessage: X");
        }
        ...
        private void performTransitions() {
            ...
            while (mDestState != null) {
                if (mDbg) LogUtil.d(TAG, "handleMessage: new destination call exit");
            ...
            if (destState != null) {
                if (destState == mQuittingState) {
                    ...
                    if (mSm.mSmThread != null) {
                        ...
                        if (mDbg) LogUtil.d(TAG, "quit the looper");
                    }
        ...
        private final void completeConstruction() {
            if (mDbg) LogUtil.d(TAG, "completeConstruction: E");
            ...
            if (mDbg) LogUtil.d(TAG, "completeConstruction: maxDepth=" + maxDepth);
            ...
            if (mDbg) LogUtil.d(TAG, "completeConstruction: X");
        }
        ...
        private final void processMsg(Message msg) {
            ...
            if (mDbg) {
                LogUtil.d(TAG, "processMsg: " + curStateInfo.state.getName());
            }
        ...
        private final void invokeExitMethods(StateInfo commonStateInfo) {
            while ((mStateStackTopIndex >= 0) &&
                ...
                if (mDbg) LogUtil.d(TAG, "invokeExitMethods: " + curState.getName());
                curState.exit();
        ...
        private final void invokeEnterMethods(int stateStackEnteringIndex) {
            for (int i = stateStackEnteringIndex; i <= mStateStackTopIndex; i++) {
                if (mDbg) LogUtil.d(TAG, "invokeEnterMethods: " + mStateStack[i].state.getName());
        ...
        private final void moveDeferredMessageAtFrontOfQueue() {
            ...
            for (int i = mDeferredMessages.size() - 1; i >= 0; i-- ) {
                ...
                if (mDbg) LogUtil.d(TAG, "moveDeferredMessageAtFrontOfQueue; what=" + curMsg.what);
        ...
        private final int moveTempStateStackToStateStack() {
            ...
            int j = startingIndex;
            while (i >= 0) {
                if (mDbg) LogUtil.d(TAG, "moveTempStackToStateStack: i=" + i + ",j=" + j);
            ...
            if (mDbg) {
                LogUtil.d(TAG, "moveTempStackToStateStack: X mStateStackTop="
        ...
        private final StateInfo setupTempStateStackWithStatesToEnter(State destState) {
            ...
            if (mDbg) {
                LogUtil.d(TAG, "setupTempStateStackWithStatesToEnter: X mTempStateStackCount="
        ...
        private final void setupInitialStateStack() {
            if (mDbg) {
                LogUtil.d(TAG, "setupInitialStateStack: E mInitialState="
        ...
        private final StateInfo addState(State state, State parent) {
            if (mDbg) {
                LogUtil.d(TAG, "addStateInternal: E state=" + state.getName()
            ...
            if (mDbg) LogUtil.d(TAG, "addStateInternal: X stateInfo: " + stateInfo);
            return stateInfo;
        }
        ...
        private final void setInitialState(State initialState) {
            if (mDbg) LogUtil.d(TAG, "setInitialState: initialState" + initialState.getName());
        ...
        private final void transitionTo(IState destState) {
            ...
            if (mDbg) LogUtil.d(TAG, "StateMachine.transitionTo EX destState" + mDestState.getName());
        }

        /** @see StateMachine#deferMessage(Message) */
        private final void deferMessage(Message msg) {
            if (mDbg) LogUtil.d(TAG, "deferMessage: msg=" + msg.what);
    ...
    protected void unhandledMessage(Message msg) {
        if (mSmHandler.mDbg) LogUtil.e(TAG, mName + " - unhandledMessage: msg.what=" + msg.what);
    }
